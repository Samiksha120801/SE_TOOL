...
ws = Tk()
ws.title('Registration Window')

ws.geometry('1000x600')
ws.minsize(1000,600)
ws.maxsize(1000,600)
bg = PhotoImage(file = "se_bg.png")
...
def insert_record():
    ...
    if register_name.get() == "":
        ...
        check_counter += 1
    """
    elif register_name.get().isalnum() == True:
        warn = "Name cannot contain numbers"

    else:
        check_counter += 1
    """
    temp = 0
    for i in register_email.get():
        if i == '@':
            temp = 1
    #print(temp)
    ...
    elif register_mobile.get().isdigit() == False:

        warn = "Contact number should contain digits only"

    elif len(register_mobile.get()) != 10:

        warn = " Enter valid Contact number"
    else:
        check_counter += 1
    ...
    elif len(register_pwd.get()) < 8:

        warn = "Passward should contain minimum 8 characters"
    elif register_pwd.get().isdigit() or register_pwd.get().isalpha() or register_pwd.get().isalnum():
        warn = " Passward should contain Alphabet, Digit and symbol"
